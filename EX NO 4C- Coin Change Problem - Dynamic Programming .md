...
2.Initialize a DP array dp[] of size amount + 1, where dp[i] stores the minimum number of coins
to make amount i.
...
<img width="330" height="237" alt="image" src="https://github.com/user-attachments/assets/a716972f-accb-451e-8137-a726fce921e8" />
